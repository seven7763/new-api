...
// SessionCookieOriginGuard protects the cookie-authenticated refresh/logout
// endpoints. It intentionally does not add CORS response headers and must not
// be installed on relay routes.
