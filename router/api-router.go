	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				// Each call runs two full-table aggregations over users/invite_rebates.
				selfRoute.GET("/invite_rebate/leaderboard", middleware.UserCriticalRateLimit("invite-rebate-leaderboard"), controller.GetInviteRebateLeaderboard)
