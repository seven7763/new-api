...
describe('API key group table cell', () => {
  test('renders two unclipped Auto rings and a localized Auto ratio when API data uses a nonlocalized string', () => {
  ...
  test('hides the Cross-group badge when the key has cross-group retry disabled', () => {
    const { container } = render(
      <CellHarness
        group='auto'
        ratio='Auto'
