...
export const STATIC_I18N_KEYS = [
  ...
  'Basis points: 100 = 1% of credited quota',
  'Count',
  'Credit inviter when invitees complete top-ups',
  'Failed to load admin rebate data',
  'Failed to load invite rebate data',
  'Filter',
  'Invite Rebate',
  'Invite Rebates',
  'Invite Rebates (Admin)',
  'Invite Top-up Rebate',
  'Invite Top-up Rebate Ratio (bp)',
  'Invitee',
  'Invitee ID',
  'Invitee top-up total',
  'Invitees',
  'Inviter',
  'Inviter ID',
  'No invitees yet',
  ...
  'Rebate',
  'Rebate logs',
  'Rebate rate: {{rate}}% of invitee credited top-ups',
  'Rebate sum',
  'Rebate total',
  'Rows',
  'Time',
  'Top-up',
  'Top-up rebate is currently disabled by admin',
  'Top-up sum',
  'Top-up total',
  'Trade no',
  'Transfer failed',
